...
int option = 0;
while(option != 7) //while loop is used so user can enter option of which task to perform and it will execute till it get value 3
{
    Console.WriteLine("-------------------------------------------");
    Console.WriteLine("Press 1 for add contact.\nPress 2 for list the contact.\nPress 3  to edit the contact.");
    Console.WriteLine("Press 4 to delete the contact.\nPress5 to add Unique contact.");
    ...
    switch(option)
    {
        ...
        case 6: // if option 6 is entered then it will display the unique contacts from dictionary
            ...
            break;
        case 7:// if option value 7 is entered then it matches with this case and it will exit the code after displaying message
