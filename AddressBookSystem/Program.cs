...
int option = 0;
while(option != 4) //while loop is used so user can enter option of which task to perform and it will execute till it get value 3
{
    Console.WriteLine("-------------------------------------------");
    ...
    switch(option)
    {
        ...
        case 3:// if option value 3 is entered then it matches with this case and user will be able to edit the contact
            ...
            break;
        case 4:// if option value 4 is entered then it matches with this case and it will exit the code after displaying message
